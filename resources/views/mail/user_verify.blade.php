            ...
            <tr>
                <td align="left" valign="center">
                    <div
                        ...
                        <div style="padding-bottom: 30px">
                            We are excited to inform you that your {{$setting->website_name}} account has been approved! You can now log in and start exploring our range of products.
                        </div>
                        ...
                        <div style="padding-bottom: 30px">
                            Thank you for choosing {{$setting->website_name}}. We look forward to serving your business needs.
                        </div>
                        ...
                        <!--end:Email content-->
                        <div style="padding-bottom: 10px">Best regards,<br>The {{$setting->website_name}} Team.</div>
                    </div>
                </td>
            </tr>
            <tr>
