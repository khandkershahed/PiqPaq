    ...
    <div class="ps-about">
        ...
        <div class="ps-about__content">
            ...
            <section class="ps-about__project">
                <div class="container">
                    <h2 class="ps-about__title">Welcome to {{$setting->website_name}}, your premier destination for wholesale solutions.
                    </h2>
                    <section class="ps-section--block-grid">
                        ...
                        <div class="ps-section__content">
                            ...
                            <div class="ps-section__desc">At {{$setting->website_name}}, we pride ourselves on delivering top-quality
                    ...
                    <section class="ps-section--block-grid row-reverse">
                        ...
                        <div class="ps-section__content">
                            ...
                            <div class="ps-section__desc">At {{$setting->website_name}}, we are dedicated to empowering your business
                    ...
                    <section class="ps-section--block-grid">
                        ...
                        <div class="ps-section__content">
                            ...
                            <div class="ps-section__desc">At {{$setting->website_name}}, we're committed to driving wholesale excellence by
