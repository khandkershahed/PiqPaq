<x-frontend-app-layout :title="'Contact Us'">
    ...
    <div class="container my-5">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div>
                    <h1 class="text-start mb-5 display-4"><span class="display-3 fw-bold">{{$setting->website_name}}</span> <br> Frequently Asked Questions (FAQ)</h1>
                    <p>Find answers to all your questions about shopping at {{$setting->website_name}}. Our FAQ section covers everything
